...
void genLabyrinth(cv::Mat& map) {
	...
	player.position.x = (-start_position.x * BLOCK_SIZE) - BLOCK_SIZE / 2.0f;
	player.position.z = (-start_position.y * BLOCK_SIZE) - BLOCK_SIZE / 2.0f;
}
